...
async def help (ctx):
	...
	emb.add_field(name = '{}exchange_rates'.format(settings['PREFIX']), value = 'Показать курс определённой валюты на сегодня. Список доступных валют: доллар, евро, биткоин, тенге, гривна, шекель. Пример: &exchange_rates шекель')
